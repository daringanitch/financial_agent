...
helm.sh/chart: {{ include "financial-agent.chart" . }}
{{ include "financial-agent.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
app.kubernetes.io/name: {{ include "financial-agent.name" . }}
...
Namespace name
*/}}
{{- define "financial-agent.namespace" -}}
